...
begin
  ...
  try
    ...
    TempBitmap.FillRect(0,0,10,25, ROMData.ReturnNESPal(ROMData.Palette[EditorConfig.LastPaletteTileEditor,0]));
    TempBitmap.FillRect(10,0,20,25, ROMData.ReturnNESPal(ROMData.Palette[EditorConfig.LastPaletteTileEditor,1]));
    TempBitmap.FillRect(20,0,30,25, ROMData.ReturnNESPal(ROMData.Palette[EditorConfig.LastPaletteTileEditor,2]));
    TempBitmap.FillRect(30,0,40,25, ROMData.ReturnNESPal(ROMData.Palette[EditorConfig.LastPaletteTileEditor,3]));
    if SelPalLeft = SelPalRight then
    begin
      TempBitmap.Line(SelPalLeft*10,0,SelPalLeft*10, 25,EditorConfig.LeftTextColour);
      TempBitmap.Line(SelPalLeft*10,0,SelPalLeft*10 + 10,0,EditorConfig.LeftTextColour);
      TempBitmap.Line(SelPalRight*10 + 9,1,SelPalRight*10 + 9,25,EditorConfig.MiddleTextColour);
      TempBitmap.Line(SelPalRight*10,24,SelPalRight*10 + 9,24,EditorConfig.MiddleTextColour);
...
//      TempBitmap.FrameRectS(SelPalRight * 10,0,SelPalRight * 10 + 10,25,RNAOptions.MiddleTextColour);
    ...
    begin
      TempBitmap.FrameRectS(SelPalLeft * 10,0,SelPalLeft * 10 + 10,25,EditorConfig.LeftTextColour);
      TempBitmap.FrameRectS(SelPalRight * 10,0,SelPalRight * 10 + 10,25,EditorConfig.MiddleTextColour);
    end;
...
begin
  ...
  try
    ...
    for x := 0 to 7 do
      for i := 0 to 7 do
        TempBitmap.Pixel[x,i] := ROMData.ReturnNESPal(ROMData.Palette[EditorConfig.LastPaletteTileEditor,DaTile.Pixels[i,x]]);
